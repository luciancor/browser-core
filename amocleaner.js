...
// remove all files from this filder with expections
...
cleanFolders('./', ['bin', 'guides', 'tests'], false);
...
cleanFolders('specific', ['chromium', 'mobile', 'node', 'react-native', 'web', 'webextension'], false);
cleanFolders('platforms', ['node', 'react-native', 'web', 'webextension', 'chromium', 'mobile'], false);
cleanFolders('configs', ['ci', 'experiments'], false);

cleanFolderWithExceptions('./', ['.eslintignore', '.eslintrc', '.gitignore', 'LICENSE', 'README.md', 'amocleaner.js', 'config.es', 'fern.js', 'package.json', 'Brocfile.js'], false);
